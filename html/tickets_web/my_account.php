...
$query = "SELECT * from movies inner join orders using(mid) inner join user using(uid) where uid=$uid ORDER BY oid  desc limit 10";
            ...
            <div class="bootstrap_container">
                <nav class="navbar navbar-default w3_megamenu" role="navigation">
                    <div class="navbar-header">
                        ...
                        <a href="index.html" class="navbar-brand"> <i class="fa fa-home"></i>
                        </a>
                    </div>
                    <!-- end navbar-header -->
                    <div id="defaultmenu" class="navbar-collapse collapse">
                        ...
                        <?php 
                        if($_SESSION['login']){
                            echo '<li class="active"><a href="my_account.php">我的账号</a></li>';
                                                    ...
                                                    <div class="tab-pane" id="Registration">
                                                        <form role="form" class="form-horizontal" method="post" action="regist.php">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input name="re_tel" class="form-control" id="tel" placeholder="Mobile" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    name="re_password" id="re_password" placeholder="Password" />
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-2"></div>
...
if (mysql_num_rows($result) > 0) {
    ...
    while($row = mysql_fetch_assoc($result)) {
        ...
        echo '<div class="col-md-4 event-grid">';
        echo 	'<a href="#">';
        echo 		"<img class=\"img-responsive\" src=\"./poster/".$row['mid'].".png\" alt=\"\" />";
        echo 	'</a>';
        echo 	'<div class="event-info">';
        echo 		"<a class=\"m-movie-link\" href=\"\">".$row['movie_name']."</a>";
        echo 	"<span>".$row['movie_message']."</span>";
        echo 	"<p><label>"."可在手机客户端获取二维码入场"."</label></p>";
        echo 	"<a class=\"e-green\" href=\"delete_ticket.php?oid=$oid\">删除该电影票</a>";
        echo 	"<div class=\"clearfix\"></div>";
        		if($row['state'] == 1)
        			echo "<a class=\"buy\" ><strong><p style=\"font-size:14px\">未使用</p></strong></a>";
        		else
        			echo "<a class=\"buy\" ><strong><p style=\"font-size:14px; color:red\">已使用</p></strong></a>";
        echo 	"</div>";
        echo "</div>";
    }
} else {
...
?>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                                    <div class="col-md-4 event-grid">
                                        ...
                                        <div class="event-info">
                                            <a class="m-movie-link" href="#">Ladakh Expedition 2015</a>
                                            <span>Leh</span>
                                            <p>
                                                <label>This weekend</label>
                                                4 Jul - 5 Sep
                                            </p>
                                            <a class="e-green" href="#">Adventure</a>
                                            <div class="clearfix"></div>
                                            <a class="buy" href="events-ticket-booking.html">buy tickets</a>
                                        </div>
                                    </div>
                                    <div class="col-md-4 event-grid">
                                        <a href="event-single.html">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                                    ...
                                    <div class="col-md-4 event-grid">
                                        ...
                                        <div class="event-info">
                                            ...
                                            <a class="m-green" href="#">Adventure</a>
                                            <div class="clearfix"></div>
                                            <a class="buy" href="events-ticket-booking.html">buy tickets</a>
                                        </div>
                                    </div>
                ...
                <div class="footer-top-strip">
                    <p>
                        <span>Showing in cities :</span>
                        <a href="movies.html">Bengaluru</a> ,
                        <a href="movies.html">Hyderabad</a> ,
                        <a href="movies.html">Khammam</a> ,
                        <a href="movies.html">Kurnool</a> ,
                        <a href="movies.html">Nizamabad</a> ,
                        <a href="movies.html">Vijayawada</a> ,
                        <a href="#">Vizag</a> ,
                        <a href="movies.html">Vizianagaram</a> ,
                        <a href="movies.html">Warangal</a>
                    </p>
                    <p>
                        <span>Cinemas Nearby :</span>
                        <a href="movie-single.html">INOX: Jyoti Mall, Kurnool</a> |
                        <p>
                            <span>
								Next Change
								<i>(Friday, 19 Jun)</i>
                ...
                <div class="footer-right">
                    ...
                    <div class="recent_24by7">
                        <a class="play-icon popup-with-zoom-anim" href="#small-dialog" href="#">
                            <i class="fa fa-calendar-o"></i> Resend Booking Confirmation
                        </a>
                        <a href="support.html">
                            <i class="fa fa-question"></i> 24/7 Customer Care
                        </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
    ...
    <a href="#gotop" class="scroll" id="toTop" style="display: block;">
